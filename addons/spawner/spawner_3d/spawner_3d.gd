...
func get_selected_spawn_points() -> Array[Marker3D]:
...
func select_random_spawn_points() -> Array[Marker3D]:
	var selected_spawn_points: Array[Marker3D] = []
...
func select_spawn_points(ASC: bool = true) -> Array[Marker3D]:
	var selected_spawn_points: Array[Marker3D] = []
	var counter:int = 0
	if ASC:
...
func instantiate_scene_from_entry(wave_entry: WaveEntry, spawnpoint: Marker3D) -> void:
